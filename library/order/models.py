...
class Order(models.Model):
    """
       ...
       """
    book = models.ForeignKey(Book, on_delete=models.CASCADE, default=None, verbose_name="Title")
    user = models.ForeignKey(CustomUser, on_delete=models.CASCADE, default=None, verbose_name='Library visitor')
    created_at = models.DateTimeField(auto_now_add=True, verbose_name='Created at')
    end_at = models.DateTimeField(default=None, null=True, blank=True, verbose_name='To return on')
    plated_end_at = models.DateTimeField(null=True, blank=True, default=None, verbose_name='Returned on')
    ...
    def __str__(self):
        ...
        """
        return f"ID: {self.pk}, {self.user}, {self.created_at:%Y-%m-%d}"
